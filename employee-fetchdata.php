<?php
    ...
    if(isset($_POST['search']['value'])){
        ...
        $sql .=" WHERE employeeid LIKE '%".$search_value."%' ";
        ...
        $sql .= " OR hireddate LIKE '%".$search_value."%' ";
        $sql .= " OR enddate LIKE '%".$search_value."%' ";
        $sql .= " OR workingstatus LIKE '%".$search_value."%' ";
    }
    ...
    while($row = mysqli_fetch_assoc($run_query)) {
        $subarray = array();
        $subarray[] = $row['id'];
        $subarray[] = $row['employeeid'];
        $subarray[] = $row['lastname'];
        $subarray[] = $row['firstname'];
        $subarray[] = $row['middlename'];
        $subarray[] = $row['contactnumber'];
        $subarray[] = $row['emailaddress'];
        $subarray[] = $row['address'];
        $subarray[] = $row['birthdate'];
        $subarray[] = $row['hireddate'];
        $subarray[] = $row['enddate'];
        $subarray[] = $row['workingstatus'];
